...
$acc_username = "Marlon123";
$acc_password = "Velasco123";
$acc_fullname = "Marlon Velasco";
$acc_address = "Mahinhin, Boac, Marinduque";
//check the current URL address for the redirections
$url_add = "http://".$_SERVER['HTTP_HOST'].$_SERVER['PHP_SELF'];




//condition para malaman kung ang button ay pinindot
		      	...
		      	<h3 class="text-center mb-4">MyTumblr Login</h3>
		      		...
		      		<div class="form-group">
		      			...
		      			if (isset($_REQUEST['notexist']) === true){
		      					echo "<div class='alert alert-danger' role='alert'> Username does not exist...
		      						</div>";
